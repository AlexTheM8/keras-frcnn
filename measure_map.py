...
parser.add_option("-o", "--parser", dest="parser", help="Parser to use. One of simple or pascal_voc",
                  default="pascal_voc"),
parser.add_option("-i", "--output_model_number", dest="model_iter",
                  help="Models of Epoch step to use. Type this with leading spaces for the hdf5 files!"),
...
if K.image_data_format() == 'channels_first':
    ...
    input_shape_img = (None, 3)
    input_shape_features = (None, 1024)
